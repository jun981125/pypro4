# 공공데이터 중 출입국관광서비스 자료를 사용 - 국내 유료 관광지에 방문한 외국인 관광객
import pandas as pd
import numpy as np
...
#	print(merge_table)
	...
	plt.scatter(merge_table['japan'], merge_table['ForNum'], s=5, c='blue')
	...
	plt.scatter(merge_table['usa'], merge_table['ForNum'], s=5, c='green')
...
#	print(resNm)		#['창덕궁' '운현궁' '경복궁' '창경궁' '종묘']
